...
class SizeController extends Controller
{
    ...
    {
        $results = Size::orderBy('size', 'asc')->get();
        return view('admin.size.index', compact('results'));
    }
...
;
        if (array_key_exists('btn_create_and_edit', $request->all())) {
            return redirect()->route('admin.size.edit', ['size' => $size->id]);
    ...
    public function edit($id)
    {
        ...
        return view('admin.size.edit', compact('result'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $size = $result->update($validated);

        if (array_key_exists('btn_update_and_edit', $request->all())) {
            return redirect()->route('admin.size.edit', ['size' => $result->id]);
