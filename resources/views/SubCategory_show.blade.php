        ...
        <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{$subcategory[0]->title}}</li>
                </ol>
            </div><!-- End .container -->
                                ...
                                <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                    <div class="product product-7 text-center">
                                        <figure class="product-media">
                                            <a href="{{route('product-page',['slug' => $item->slug,'id'=>$item->id])}}">
                                                ...
                                                <div class="filter-item">
                                                    <div class="custom-control custom-checkbox">
                                                        @foreach($subcategory as $item)
                                                            ...
                                                            <a href=""> <label class="custom-control-label" >{{$item->title}}</label></a>
                                                        @endforeach
