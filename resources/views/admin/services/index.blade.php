            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="float-right">
                        <a href="{{ route('admin.service.create') }}" class="btn btn-primary btn-sm">Добавить Услуги</a>
                    </div>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        @forelse($results as $result)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('admin.service.edit',['service'=>$result->id]) }}"
                                           class="btn btn-sm btn-default edit_link" title="Редактировать">
                                            <i class="fas fa-pencil-alt"></i>
                                            Редактировать
                                        </a>

                                        <a href="{{ route('admin.destroy',['page'=>'service','id'=>$result->id]) }}"
