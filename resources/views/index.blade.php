            ...
            <div class="products-container" data-layout="fitRows">
                ...
                <div class="product-item lighting col-6 col-md-4 col-lg-3">
                    <div class="product product-4">
                        <figure class="product-media">
                            ...
                            <a href="product.html">
                                <img src="{{asset('assets/images/demos/demo-11/products/product-2.jpg')}}" alt="Product image"
                                     class="product-image">
                            </a>
                ...
                <div class="product-item furniture col-6 col-md-4 col-lg-3">
                    <div class="product product-4">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('assets/images/demos/demo-11/products/product-3.jpg')}}" alt="Product image"
                                     class="product-image">
                            </a>
                ...
                <div class="product-item accessories lighting sale col-6 col-md-4 col-lg-3">
                    <div class="product product-4">
                        <figure class="product-media">
                            ...
                            <a href="product.html">
                                <img src="{{asset('assets/images/demos/demo-11/products/product-4.jpg')}}" alt="Product image"
                                     class="product-image">
                            </a>
                ...
                <div class="product-item furniture sale col-6 col-md-4 col-lg-3">
                    <div class="product product-4">
                        <figure class="product-media">
                            <span class="product-label">Sale</span>
                            <a href="product.html">
                                <img src="{{asset('assets/images/demos/demo-11/products/product-5.jpg')}}" alt="Product image"
                                     class="product-image">
                            </a>
                ...
                <div class="product-item furniture accessories col-6 col-md-4 col-lg-3">
                    <div class="product product-4">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('assets/images/demos/demo-11/products/product-6.jpg')}}" alt="Product image"
                                     class="product-image">
                            </a>
                ...
                <div class="product-item accessories lighting col-6 col-md-4 col-lg-3">
                    <div class="product product-4">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('assets/images/demos/demo-11/products/product-7.jpg')}}" alt="Product image"
                                     class="product-image">
                            </a>
                ...
                <div class="product-item furniture sale col-6 col-md-4 col-lg-3">
                    <div class="product product-4">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('assets/images/demos/demo-11/products/product-8.jpg')}}" alt="Product image"
                                     class="product-image">
                            </a>
                ...
                <div class="product-item furniture accessories col-6 col-md-4 col-lg-3">
                    <div class="product product-4">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('assets/images/demos/demo-11/products/product-9.jpg')}}" alt="Product image"
                                     class="product-image">
                            </a>
                ...
                <div class="product-item accessories col-6 col-md-4 col-lg-3">
                    <div class="product product-4">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('assets/images/demos/demo-11/products/product-10.jpg')}}" alt="Product image"
                                     class="product-image">
                            </a>
                ...
                <div class="product-item lighting sale col-6 col-md-4 col-lg-3">
                    <div class="product product-4">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('assets/images/demos/demo-11/products/product-11.jpg')}}" alt="Product image"
                                     class="product-image">
                            </a>
                ...
                <div class="product-item lighting sale col-6 col-md-4 col-lg-3">
                    <div class="product product-4">
                        <figure class="product-media">
                            <span class="product-label">Sale</span>
                            <a href="product.html">
                                <img src="{{asset('')}}assets/images/demos/demo-11/products/product-12.jpg" alt="Product image"
                                     class="product-image">
                            </a>
